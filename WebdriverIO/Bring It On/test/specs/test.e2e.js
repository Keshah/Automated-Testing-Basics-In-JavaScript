...
describe("Test suite", () => {
    ...
    it("First test", async () => {
        ...
        await fillForm.fillPaste("git config --global user.name 'New Sheriff in Town' </br> git reset $ (git commit-tree HEAD ^ {tree} -m 'Legacy code') git push origin master --force");
